...
public final class ProviderExample {
    ...
    public static void main(String[] args) {
        ...
        {id: 'registry-contract', title: 'Lookup and class loaders', html: '<p><code>ServiceRegistry.of(type)</code> uses the thread context class loader. When it is absent, it falls back to the service type’s loader, then the system loader. Use <code>of(type, loader)</code> when the caller must choose a loader explicitly.</p>'+table(['Operation','Result or failure'],[
